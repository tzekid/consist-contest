- - # Getting Started with Splunk
    ...
    There you can enter your Splunk login credentials (username | password)[^0]. Once logged in click on the "Search & Reporting" app on the bar on the left.
    ...
    ![This is what you](./dindindin.png)
